...
public class User_Transfer extends Functions implements ActionListener{
    ...
    Labels titleLabel, accLabel, amnLabel, toLabel;
    EmptyBorder empty;
    CompoundBorder border;
    LineBorder rounded;
    JTextField amnTField, toTField;
    JComboBox accCBox;
    ...
    User_Transfer() {
        ...
        titleLabel = new Labels("Transfer",20);
        accLabel = new Labels("Account",20);
        amnLabel = new Labels("Amount ",20);
        toLabel = new Labels("Transfer To ",20);
        ...
        toTField.setPreferredSize(new Dimension(300, 40));
        ...
        toTField.setForeground(Color.BLACK);
        ...
        accLabel.setBorder(BorderFactory.createEmptyBorder(80,0,10,220));
        amnLabel.setBorder(BorderFactory.createEmptyBorder(10,0,10,220));
        toLabel.setBorder(BorderFactory.createEmptyBorder(10,0,10,185));
        accCBox.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        amnTField.setBorder(border);
        toTField.setBorder(border);
        butPanel.setBorder(BorderFactory.createEmptyBorder(20,0,0,0));
        
        //Font
        amnTField.setFont(new Font("Comic Sans", Font.BOLD, 14));
        toTField.setFont(new Font("Comic Sans", Font.BOLD, 14));
        ...
        cenPanel.add(toLabel);
        cenPanel.add(toTField);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == lgtBtn){
            ...
            transferFunc(accCBox.getSelectedItem(), toTField.getText(), amnTField.getText(), frame);
