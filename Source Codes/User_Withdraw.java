...
public class User_Withdraw extends Functions implements ActionListener{
    ...
    User_Withdraw() {
        ...
        titleLabel = new Labels("Withdraw",20);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == lgtBtn){
            ...
            withdrawFunc(accCBox.getSelectedItem(),amnTField.getText(), frame);
        }
    }
}
